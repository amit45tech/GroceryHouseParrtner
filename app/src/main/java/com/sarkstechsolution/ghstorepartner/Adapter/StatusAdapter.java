...
import com.sarkstechsolution.ghstorepartner.ProductAvailabilityStatusActivity;
import com.sarkstechsolution.ghstorepartner.R;
import com.squareup.picasso.Picasso;

import java.util.HashMap;

public class StatusAdapter extends FirebaseRecyclerAdapter<Products, StatusAdapter.ProductViewHolder> {

    private Context context;

    public StatusAdapter(@NonNull FirebaseRecyclerOptions<Products> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
        ...
        holder.markOOS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.productMap.put("availability", "Out Of Stock");
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_available_layout, parent, false);
        return new StatusAdapter.ProductViewHolder(view);
    }

    public class ProductViewHolder extends RecyclerView.ViewHolder {

        ImageView PImg;
        TextView Pname, Pcategory, PMrp, Psp, Punit, Pstatus, markOOS;
        ...
        public ProductViewHolder(@NonNull View itemView) {
            ...
            markOOS = itemView.findViewById(R.id.mark_oos);
